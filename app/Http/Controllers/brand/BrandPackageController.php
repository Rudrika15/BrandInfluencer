...
class BrandPackageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $package->save();
        return redirect()->route('admin.brand.package.index')->with('success', 'Package added successfully');
    }
    ...
    public function update(Request $request)
    {
        ...
        $package->points = $request->points;
        $package->save();
        return redirect()->route('admin.brand.package.index')->with('success', 'Package updated successfully');
    }
    ...
    public function destroy($id)
    {
        $brandPackage = BrandPackage::find($id);
        $brandPackage->delete();
        return redirect()->route('admin.brand.package.index')->with('success', 'Package deleted successfully');
    }
}
