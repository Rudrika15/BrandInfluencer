...
//     function () {
Route::middleware(['optimize.images'])->group(
    function () {
        Route::group(['middleware' => ['auth']], function () {
            ...
            Route::get('/requests', [FollowController::class, 'index'])->name('requests');
            Route::get('/approve/{id}', [FollowController::class, 'approve'])->name('approve');
            Route::get('/reject/{id}', [FollowController::class, 'reject'])->name('reject');
            Route::get('/remove/{id}', [FollowController::class, 'remove'])->name('remove');



            // Route::get('/brands/profileView/{id?}', [App\Http\Controllers\HomepageController::class, 'profileView'])->name('brands.profileView');
