...
@section('content')
    ...
    <div class='container'>
        <div class="card w-100">
            <div class="card-body">
                <div class='row'>
                    <div class='col-md-12'>
                        <div class="d-flex justify-content-between mb-3">
                            <div class="p-2">
                                <h3 class="line-title">Add Content</h3>
                            </div>
                            <div class="p-2">
                ...
                <div class="container-fluid ">
                    ...
                    <form action="{{ route('brand.campaign.appliersCreateStore') }}" enctype="multipart/form-data"
        ...
        <div class="card w-100">
            <div class="card-body">
                <h3 class="line-title pt-3">My Media</h3>
                            ...
                            <tr>
                                <td>
                                    @if ($image->fileType == 'Photo')
                                        <img class="mt-3" src="{{ asset('checkApplyFile/' . $image->file) }}"
                                            alt=""
                                            style="height: 150px; width: 150px; border:8px solid white; box-shadow: 2px 2px 2px 2px lightblue; margin-left: 50px;">
                                    @else
                                ...
                                <td>
                                    <a class="fs-5 btn btn-sm btn-danger" onclick="return confirm('Are you sure?')"
                                        href="{{ Route('appliedPhotoDelete') }}/{{ $image->id }}">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
