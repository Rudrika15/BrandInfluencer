        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs mt-4" id="myTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link text-muted  active" id="All-tab" data-bs-toggle="tab" data-bs-target="#All"
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link text-muted  " id="News-tab" data-bs-toggle="tab" data-bs-target="#News"
                        type="button" role="tab" aria-controls="News" aria-selected="false">News</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link text-muted  " id="Sponserships-tab" data-bs-toggle="tab"
                        data-bs-target="#Sponserships" type="button" role="tab" aria-controls="Sponserships"
                        aria-selected="false">Sponserships</button>
                </li>
            </ul>
                    ...
                    @foreach ($notifications as $notification)
                        <div class="row w-75">
                            ...
                            <div class="col-md-10 pt-3 ps-3">
                                ...
                                <small
                                    class="text-muted">{{ \Carbon\Carbon::parse($notification->dateTime)->diffForHumans() }}
                                </small>
                            </div>
                            <div class="col-md-1 ">
