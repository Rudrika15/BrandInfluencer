...
@section('content')
            ...
            <div class="profile-nav-info">
                ...
                <div class="">
                    ...
                    @role('Brand')
                        ...
                        <div class="d-flex  position-relative" style="height: 100px; width: 550px;">
                            <button class="scroll-button left" onclick="scrollLeftCustom()">&#9664;</button>
                            <div class="d-flex scroll-container" style="overflow-x: hidden; width: 100%;">
                                @foreach ($brand_category as $category)
                                    <div class="d-flex gap-2 align-items-center rounded-pill bg-secondary mb-3"
                                        style="min-width: 140px; max-width: 150px; height: 45px; margin-right: 10px; margin-top: 10px;">
                                        <img class="img-thumbnail rounded-pill"
                                            src="{{ asset('brandCategoryIcon') }}/{{ $category->brandCategory->icon }}"
                                            style="height: 40px; width: 40px; object-fit: contain;" alt="">
                                        <span class="mt-1 text-white text-center" style="font-size: 12px;">
                                            {{ $category->brandCategory->categoryName }}
                                        </span>
                                    </div>
                                @endforeach
                            </div>
                            <button class="scroll-button right" onclick="scrollRightCustom()">&#9654;</button>
                        </div>
                                                        ...
                                                        <div class=" text-start" style="width: 15rem;">
                                                            ...
                                                            <a href="{{ asset('cardimage') }}/{{ $portfolio->image }}"
                                                                ...
                                                                @php
                                                                    ...
                                                                    $reelId = basename(
                                                                        parse_url($reelUrl, PHP_URL_PATH),
                                                                    );
                                                                @endphp
    ...
    <script>
        function scrollLeftCustom() {
            ...
            container.scrollLeft -= 100; // Adjust the value to control the scroll amount
        }
