        ...
        <div class="profile-header">
            <div class="profile-img">
                ...
                @if (isset($users->profilePhoto))
                    <img src="{{ asset('profile/' . $users->profilePhoto) }}" style="max-width: 300px; max-height: 500px;" alt="Profile Image">
                @else
                                    ...
                                    @foreach ($portfolio as $port)
                                        <div class="col-md-4">
                                            <div class="card text-start w-100">
                                                <a href="{{ $port->photo ? asset('portfolioPhoto') . '/' . $port->photo : 'https://via.placeholder.com/400x300?text=No+Image' }}" target="_blank">
                                                    <img src="{{ $port->photo ? asset('portfolioPhoto') . '/' . $port->photo : 'https://via.placeholder.com/400x300?text=No+Image' }}" class="card-img-top p-3 img-thumbnail portImage" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    @endforeach
