        ...
        <div class="container-fluid ">
            ...
            <form action="{{ route('brand.campaign.store') }}" enctype="multipart/form-data" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <img src="{{ url('images/default.jpg') }}" alt="{{ __('main image') }}" id="img1"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="{{ old('eligibleCriteria') }}" id="eligibleCriteria"
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" min="{{ date('Y-m-d') }}"
                        value="{{ old('startDate') }}" id="startDate" name="startDate">
                    @error('startDate')
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" min="{{ date('Y-m-d') }}" value="{{ old('endDate') }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="{{ old('task') }}" id="task"
                        name="task">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" value="{{ old('maxApplication') }}" id="maxApplication"
                        name="maxApplication">
