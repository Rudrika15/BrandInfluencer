   @extends('layouts.app')
   @section('title', 'Brand beans | InfluencerProfile')
   @section('content')
       {{-- <!DOCTYPE html>
       <html lang="en">
       ...
       <div class="container">
           ...
           <div class="profile-header card w-100">
           ...
           <div class="main-bd d-flex gap-5">
               <div class="left-side card w-25 "">
                   <div class="profile-side card-body">
               ...
               <div class="right-side  card w-75">
                   <div class="card-body">
                       <div class="nav">
                           <ul>
                               <a onclick="tabs(0)" class="nav-tab user-post active">Gallery</a>
                               <a onclick="tabs(1)" class="nav-tab user-review">Packages</a>
                           </ul>
                       </div>
